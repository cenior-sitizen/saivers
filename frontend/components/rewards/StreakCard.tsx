...
export function StreakCard({
  ...
  return (
    <div className="rounded-2xl border border-[#86CCD2]/30 bg-gradient-to-br from-amber-50/80 to-white p-5 shadow-sm dark:from-amber-950/20 dark:to-zinc-900 dark:border-[#86CCD2]/20">
      <div className="flex items-center gap-3">
        ...
        <div>
          <p className="text-3xl font-bold text-zinc-900 dark:text-zinc-50">
            {currentStreak}
            <span className="ml-1 text-lg font-medium text-[#666666] dark:text-zinc-400">
              days
            </span>
          </p>

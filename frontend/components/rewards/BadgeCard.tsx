  ...
  return (
    <div
      className={`rounded-2xl border p-4 ${
        unlocked
          ? "border-[#86CCD2]/40 bg-white shadow-sm dark:border-[#86CCD2]/20 dark:bg-zinc-900"
          : "border-zinc-200 bg-zinc-50/50 opacity-70 dark:border-zinc-700 dark:bg-zinc-900/50"
      }`}
    >

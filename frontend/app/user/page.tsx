...
export default function UserPage() {
  return (
    <div className="min-h-screen bg-[#F3F9F9] px-4 py-6 dark:bg-zinc-950 sm:mx-auto sm:max-w-md sm:px-0">
      ...
      {/* Aircon Impact - team's usage, trends & savings feature */}
      <Link
        href="/user/aircon-impact"
        className="mb-6 flex items-center justify-between rounded-2xl border border-[#86CCD2]/40 bg-white px-4 py-3 shadow-sm transition-colors hover:border-[#86CCD2] dark:border-[#86CCD2]/30 dark:bg-zinc-900 dark:hover:border-[#86CCD2]/60"
      >

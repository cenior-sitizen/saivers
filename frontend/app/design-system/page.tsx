...
function Swatch({ color, label, hex }: { color: string; label: string; hex: string }) {
 ...
 <p className="text-xs font-medium text-[#4d6b70]">{label}</p>
 <p className="font-mono text-[10px] text-[#6f8c91]">{hex}</p>
 </div>
 );
}
...
export default function DesignSystemPage() {
 ...
 <div className="ds-root min-h-screen px-4 py-8 pb-16 sm:mx-auto sm:max-w-2xl sm:px-6">
 {/* Header */}
 <div className="mb-10">
 ...
 <h1 className="ds-display text-4xl text-[#10363b]">
 Design System
 </h1>
 </div>
 </div>
 <p className="mt-2 text-sm text-[#6f8c91]">
 ...
 <Swatch color="" label="Background" hex="#F3F9F9" />
 <Swatch color="bg-emerald-500" label="Success" hex="#10B981" />
 <Swatch color="bg-red-500" label="Alert" hex="#EF4444" />
 <Swatch color="" label="Text Primary" hex="#18181B" />
 <Swatch color="bg-[#6f8c91]" label="Text Muted" hex="#A1A1AA" />
 </div>
 </Section>

 {/* Typography */}
 <Section title="Typography">
 <div className="space-y-4 rounded-2xl border border-[#86CCD2]/30 bg-white p-5">
 <div>
 <p className="mb-1 text-[10px] text-[#6f8c91]">DM Serif Display — Display / Hero numbers</p>
 <p className="ds-display text-4xl text-[#10363b]">240 pts · S$5.00</p>
 </div>
 <div className="h-px bg-[rgba(207,228,230,0.30)]" />
 <div>
 <p className="mb-1 text-[10px] text-[#6f8c91]">DM Sans 600 — Section headings</p>
 <p className="text-xl font-semibold text-[#10363b]">Energy Usage This Week</p>
 </div>
 <div className="h-px bg-[rgba(207,228,230,0.30)]" />
 <div>
 <p className="mb-1 text-[10px] text-[#6f8c91]">DM Sans 500 — Card titles</p>
 <p className="text-base font-medium text-[#10363b]">Off-peak AC Habit</p>
 </div>
 <div className="h-px bg-[rgba(207,228,230,0.30)]" />
 <div>
 <p className="mb-1 text-[10px] text-[#6f8c91]">DM Sans 400 — Body / descriptions</p>
 <p className="text-sm text-[#4d6b70]">Your air conditioning ran 7 hours overnight between 12am–5am at 20°C, contributing to a 40% increase in energy usage.</p>
 </div>
 <div className="h-px bg-[rgba(207,228,230,0.30)]" />
 <div>
 <p className="mb-1 text-[10px] text-[#6f8c91]">Uppercase tracking — Labels / metadata</p>
 ...
 { label: "Read", cls: "bg-[#eef6f6] text-[#6f8c91]" },
 { label: "Approved ✓", cls: "bg-emerald-100 text-emerald-700" },
 { label: "Dismissed", cls: "bg-[#eef6f6] text-[#6f8c91]" },
 { label: "On", cls: "bg-emerald-100 text-emerald-700" },
 { label: "Off", cls: "bg-[#eef6f6] text-[#4d6b70]" },
 ].map((b) => (
 ...
 <button className="rounded-xl border border-[rgba(157,207,212,0.30)] px-4 py-1.5 text-xs font-medium text-[#6f8c91] transition-colors hover:bg-[#86CCD2]/10">
 Dismiss
 </button>
 ...
 <p className="text-sm font-semibold text-[#10363b]">Standard Card</p>
 <p className="mt-1 text-xs text-[#6f8c91]">border-[#86CCD2]/30, bg-white, rounded-2xl, shadow-sm</p>
 </div>
 ...
 {/* Insight card */}
 <div className="rounded-2xl border border-[#86CCD2]/30 bg-sky-50/60 px-4 py-3">
 <p className="text-sm font-semibold text-[#10363b]">AI Insight Card (unread)</p>
 <p className="mt-1 text-xs text-[#6f8c91]">bg-sky-50/60 highlight for unread state</p>
 </div>

 {/* Approved confirmation card */}
 <div className="rounded-2xl border border-emerald-200 bg-emerald-50 px-4 py-3">
 <p className="text-sm font-semibold text-emerald-800">Approved Confirmation Card</p>
 ...
 <div key={m.label} className="rounded-xl border border-[#86CCD2]/20 bg-white px-3 py-3">
 <p className="text-xs text-[#6f8c91]">{m.label}</p>
 <p className="mt-0.5 text-lg font-semibold text-[#10363b]">{m.value}</p>
 </div>
 ))}
 </div>
 </div>
 ...
 <div className="flex items-center gap-4 rounded-2xl border border-[#86CCD2]/30 bg-white p-4">
 <div className="relative">
 <div className="rounded-full p-2 text-[#6f8c91]">
 ...
 <div>
 <p className="text-sm font-medium text-[#10363b]">NotificationBell</p>
 <p className="text-xs text-[#6f8c91]">Red badge for unread count · Dropdown with insight cards</p>
 </div>
 </div>
 </Section>
 ...
 <div className="rounded-2xl border border-[#86CCD2]/30 bg-white p-4">
 <p className="mb-3 text-xs font-semibold uppercase tracking-wider text-[#6f8c91]">Household Switcher</p>
 <div className="inline-flex items-center gap-1.5 rounded-full border border-[#86CCD2]/40 bg-white/80 px-3 py-1 text-xs font-medium text-[#4d6b70] shadow-sm">
 <span className="h-2 w-2 rounded-full bg-[#86CCD2]" />
 Ahmad
 <svg className="h-3 w-3 text-[#6f8c91]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
 <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M19 9l-7 7-7-7" />
 </svg>
 </div>
 <p className="mt-2 text-xs text-[#6f8c91]">Dropdown with 3 demo personas: Ahmad (Waster), Priya (Moderate), Wei Ming (Champion)</p>
 </div>

 {/* Time range toggle */}
 <div className="rounded-2xl border border-[#86CCD2]/30 bg-white p-4">
 <p className="mb-3 text-xs font-semibold uppercase tracking-wider text-[#6f8c91]">Time Range Toggle</p>
 <div className="flex gap-1 rounded-xl bg-[#eef6f6] p-1">
 {["Day", "Week", "Month"].map((t, i) => (
 <button
 key={t}
 className={`flex-1 rounded-lg py-1.5 text-xs font-medium transition-all ${
 i === 1
 ? "bg-white text-[#10363b] shadow-sm"
 : "text-[#6f8c91] hover:text-[#007B8A]"
 }`}
 >
 {t}
 </button>
 ...
 <div className="rounded-2xl border border-[#86CCD2]/30 bg-white p-5">
 ...
 <ul className="space-y-1.5 text-xs text-[#4d6b70]">
 <li>· Primary teal <code className="rounded bg-[#eef6f6] px-1">#007B8A</code> mirrors SP Group's brand teal</li>
 ...
 <div key={c.name} className="rounded-xl border border-[rgba(157,207,212,0.20)] bg-white p-3">
 <p className="text-xs font-semibold text-[#10363b]">{c.name}</p>
 <p className="mt-0.5 font-mono text-[9px] text-[#6f8c91] truncate">{c.path}</p>
 </div>
 ))}
 </div>
 </Section>
